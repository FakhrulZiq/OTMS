    ...
    <body>
        ...
        <script>
            function myFunction() {
                Swal.fire({
                    ...
                    text: 'Please complete the user profile before creating a new registration!',
                    icon: 'warning',
        ...
        <script>
            function showPaymentPopup() {
                Swal.fire({
                    title: 'Incomplete Registration Fee',
                    text: 'Please complete the Registration Fee to get access to this function!',
                    icon: 'warning',
                    confirmButtonText: 'OK'
                }).then((result) => {
