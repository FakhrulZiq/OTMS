...
<div class="container bootstrap snippet">
    ...
    <div class="row">
        <!--left col-->
        <div class="col-sm-3">
            <form class="form" action="{{ route('teachers.update', $teacher->id) }}" method="POST" id="registrationForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <hr>
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <input type="text" class="form-control" name="FullName" id="FullName" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" value="{{$teacher->FullName}}" required>
                            </div>
                        </div>
                        <div class="form-group"> 
                            <div class="col-xs-12">
                                <label for="last_name"><h4>IC Number</h4></label>
                                <input type="tel " class="form-control" name="ICno" id="ICno" pattern="[0-9]{6}-[0-9]{2}-[0-9]{4}" value="{{$teacher->ICno}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-1"><h4>Address-1</h4></label>
                                <input type="text" class="form-control" name="Address1" id="Address1" value="{{$teacher->Address1}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-2"><h4>Address-2</h4></label>
                                <input type="text" class="form-control" name="Address2" id="Address2" value="{{$teacher->Address2}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="State"><h4>Poscode</h4></label>
                                <input type="number" class="form-control" name="Poscode" id="Poscode" value="{{$teacher->Poscode}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="city"><h4>City</h4></label>
                                <input type="text" class="form-control" name="City" id="City" value="{{$teacher->City}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="DateJoin" id="DateJoin" value="{{$teacher->created_at}}" readonly>
                            </div>
                        </div>
