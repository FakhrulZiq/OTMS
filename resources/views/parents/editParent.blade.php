...
<div class="container bootstrap snippet">
    ...
    <div class="row">
        <!--left col-->
        <div class="col-sm-3">
            <form action="{{ route('parents.update', ['parent' => $parent->id]) }}" method="POST" id="registrationForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <hr>
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="FullName" id="FullName" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" value="{{$parent->FullName}}" required>
                            </div>
                        </div>
                        <div class="form-group"> 
                            <div class="col-xs-6">
                                <label for="last_name"><h4>IC Number</h4></label>
                                <input type="tel " class="form-control" name="ICno" id="ICno" pattern="[0-9]{6}-[0-9]{2}-[0-9]{4}" value="{{$parent->ICno}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-1"><h4>Address-1</h4></label>
                                <input type="text" class="form-control" name="Address1" id="Address1" value="{{$parent->Address1}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-2"><h4>Address-2</h4></label>
                                <input type="text" class="form-control" name="Address2" id="Address2" value="{{$parent->Address2}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-2">
                                <label for="State"><h4>Poscode</h4></label>
                                <input type="number" class="form-control" name="Poscode" id="Poscode" value="{{$parent->Poscode}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-4">
                                <label for="city"><h4>City</h4></label>
                                <input type="text" class="form-control" name="City" id="City" value="{{$parent->City}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="state"><h4>State</h4></label>
                                <input type="text" class="form-control" name="State" id="State" value="{{$parent->State}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="Nationality" id="Nationality" value="{{$parent->Nationality}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="number" class="form-control" name="Income" id="Income" value="{{$parent->Income}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-1"><h4>Office Address 1</h4></label>
                                <input type="text" class="form-control" name="OfficeAddress1" id="OfficeAddress1" value="{{$parent->OfficeAddress1}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="address-2"><h4>Office Address-2</h4></label>
                                <input type="text" class="form-control" name="OfficeAddress2" id="OfficeAddress2" value="{{$parent->OfficeAddress2}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label for="State"><h4>Office Poscode</h4></label>
                                <input type="number" class="form-control" name="OfficePoscode" id="OfficePoscode" value="{{$parent->OfficePoscode}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">
                                <label for="city"><h4>Office City</h4></label>
                                <input type="text" class="form-control" name="OfficeCity" id="OfficeCity" value="{{$parent->OfficeCity}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="state"><h4>Office State</h4></label>
                                <input type="text" class="form-control" name="OfficeState" id="OfficeState" value="{{$parent->OfficeState}}" required>
                            </div>
                        </div>
